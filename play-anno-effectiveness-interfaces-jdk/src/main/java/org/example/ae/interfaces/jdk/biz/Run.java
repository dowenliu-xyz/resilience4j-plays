package org.example.ae.interfaces.jdk.biz;
...
public class Run {
    ...
    public static CaseEffectiveness detectEffectiveness(@NotNull DemoCase demoCase) {
        ...
        try {
            ...
            } else if ("object is not an instance of declaring class".equals(e.getMessage())) {
                effectiveFallback = DemoCase.EffectiveFallback.Bug2096;
            } else {
                throw e;
            }
