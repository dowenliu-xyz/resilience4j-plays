...
public class Case018Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case018JavaInterfaceJavaDemo")
    private DemoCase javaInterfaceJavaDemo;
    @Resource(name = "case018JavaInterfaceKotlinDemo")
    private DemoCase javaInterfaceKotlinDemo;
    @Resource(name = "case018KotlinInterfaceJavaDemo")
    private DemoCase kotlinInterfaceJavaDemo;
    @Resource(name = "case018KotlinInterfaceKotlinDemo")
