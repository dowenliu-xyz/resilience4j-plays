...
public class Case198Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case198JavaInterfaceJavaDemo")
    private DemoCase javaInterfaceJavaDemo;
    @Resource(name = "case198JavaInterfaceKotlinDemo")
    private DemoCase javaInterfaceKotlinDemo;
    @Resource(name = "case198KotlinInterfaceJavaDemo")
    private DemoCase kotlinInterfaceJavaDemo;
    @Resource(name = "case198KotlinInterfaceKotlinDemo")
