...
public class Case150Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case150JavaInterfaceJavaDemo")
    private DemoCase javaInterfaceJavaDemo;
    @Resource(name = "case150JavaInterfaceKotlinDemo")
    private DemoCase javaInterfaceKotlinDemo;
    @Resource(name = "case150KotlinInterfaceJavaDemo")
    private DemoCase kotlinInterfaceJavaDemo;
    @Resource(name = "case150KotlinInterfaceKotlinDemo")
