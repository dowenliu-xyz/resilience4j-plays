...
@Component
public class InterfaceOriginMethodOverriddenDefaultMethodAnnoKotlinInterfaceJavaDemo implements InterfaceOriginMethodOverriddenDefaultMethodAnnoKotlinInterfaceForJava {
    @NotNull
    @Override
