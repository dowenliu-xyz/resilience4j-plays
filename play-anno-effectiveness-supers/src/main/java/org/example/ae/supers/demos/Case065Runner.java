...
public class Case065Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case065JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case065JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case065KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case065KotlinSuperKotlinDemo")
