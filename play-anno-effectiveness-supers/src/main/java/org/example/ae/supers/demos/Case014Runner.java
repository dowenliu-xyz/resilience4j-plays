...
public class Case014Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case014JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case014JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case014KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case014KotlinSuperKotlinDemo")
