...
public class Case149Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case149JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case149JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case149KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case149KotlinSuperKotlinDemo")
