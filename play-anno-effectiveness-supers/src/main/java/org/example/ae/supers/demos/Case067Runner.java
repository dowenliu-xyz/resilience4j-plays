...
public class Case067Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case067JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case067JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case067KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case067KotlinSuperKotlinDemo")
