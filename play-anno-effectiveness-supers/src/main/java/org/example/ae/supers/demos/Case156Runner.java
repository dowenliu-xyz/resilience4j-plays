...
public class Case156Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case156JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case156JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case156KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case156KotlinSuperKotlinDemo")
