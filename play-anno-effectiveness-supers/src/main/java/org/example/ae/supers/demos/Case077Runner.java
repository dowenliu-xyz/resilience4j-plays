...
public class Case077Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case077JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case077JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case077KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case077KotlinSuperKotlinDemo")
