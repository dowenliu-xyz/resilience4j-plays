...
public class Case153Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case153JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case153JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case153KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case153KotlinSuperKotlinDemo")
