...
public class Case062Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case062JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case062JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case062KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case062KotlinSuperKotlinDemo")
