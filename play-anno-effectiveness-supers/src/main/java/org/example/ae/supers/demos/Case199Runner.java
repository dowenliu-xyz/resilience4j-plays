...
public class Case199Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case199JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case199JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case199KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case199KotlinSuperKotlinDemo")
