...
public class Case047Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case047JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case047JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case047KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case047KotlinSuperKotlinDemo")
