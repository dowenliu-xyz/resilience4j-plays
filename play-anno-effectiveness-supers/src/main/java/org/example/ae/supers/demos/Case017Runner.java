...
public class Case017Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case017JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case017JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case017KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case017KotlinSuperKotlinDemo")
