...
public class Case147Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case147JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case147JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case147KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case147KotlinSuperKotlinDemo")
