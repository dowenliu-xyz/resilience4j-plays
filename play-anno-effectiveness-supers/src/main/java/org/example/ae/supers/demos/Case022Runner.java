...
public class Case022Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case022JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case022JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case022KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case022KotlinSuperKotlinDemo")
