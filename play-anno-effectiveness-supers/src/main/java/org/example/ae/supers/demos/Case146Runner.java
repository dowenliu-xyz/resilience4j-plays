...
public class Case146Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case146JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case146JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case146KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case146KotlinSuperKotlinDemo")
