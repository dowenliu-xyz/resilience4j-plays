...
public class Case051Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case051JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case051JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case051KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case051KotlinSuperKotlinDemo")
