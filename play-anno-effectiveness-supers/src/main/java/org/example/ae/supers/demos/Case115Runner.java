...
public class Case115Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case115JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case115JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case115KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case115KotlinSuperKotlinDemo")
