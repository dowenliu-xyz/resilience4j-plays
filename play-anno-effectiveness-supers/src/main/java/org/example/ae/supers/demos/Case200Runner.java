...
public class Case200Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case200JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case200JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case200KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case200KotlinSuperKotlinDemo")
