...
public class Case012Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case012JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case012JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case012KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case012KotlinSuperKotlinDemo")
