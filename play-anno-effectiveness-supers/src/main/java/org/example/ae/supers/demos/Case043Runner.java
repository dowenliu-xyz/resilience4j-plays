...
public class Case043Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case043JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case043JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case043KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case043KotlinSuperKotlinDemo")
