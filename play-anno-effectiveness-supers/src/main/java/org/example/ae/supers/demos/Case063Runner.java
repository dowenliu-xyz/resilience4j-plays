...
public class Case063Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case063JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case063JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case063KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case063KotlinSuperKotlinDemo")
