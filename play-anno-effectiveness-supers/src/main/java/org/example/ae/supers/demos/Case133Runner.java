...
public class Case133Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case133JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case133JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case133KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case133KotlinSuperKotlinDemo")
