...
public class Case197Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case197JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case197JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case197KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case197KotlinSuperKotlinDemo")
