...
public class Case162Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case162JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case162JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case162KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case162KotlinSuperKotlinDemo")
