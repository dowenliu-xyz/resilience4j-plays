...
public class Case007Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case007JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case007JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case007KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case007KotlinSuperKotlinDemo")
