...
public class Case058Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case058JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case058JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case058KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case058KotlinSuperKotlinDemo")
