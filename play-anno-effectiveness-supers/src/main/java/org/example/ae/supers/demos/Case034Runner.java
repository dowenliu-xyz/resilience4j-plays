...
public class Case034Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case034JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case034JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case034KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case034KotlinSuperKotlinDemo")
