...
public class Case145Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case145JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case145JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case145KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case145KotlinSuperKotlinDemo")
