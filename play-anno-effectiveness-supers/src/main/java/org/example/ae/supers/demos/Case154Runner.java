...
public class Case154Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case154JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case154JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case154KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case154KotlinSuperKotlinDemo")
