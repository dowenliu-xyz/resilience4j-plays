...
public class Case140Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case140JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case140JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case140KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case140KotlinSuperKotlinDemo")
