...
public class Case082Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case082JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case082JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case082KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case082KotlinSuperKotlinDemo")
