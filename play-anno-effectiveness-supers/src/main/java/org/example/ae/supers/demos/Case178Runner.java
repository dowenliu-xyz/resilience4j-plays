...
public class Case178Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case178JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case178JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case178KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case178KotlinSuperKotlinDemo")
