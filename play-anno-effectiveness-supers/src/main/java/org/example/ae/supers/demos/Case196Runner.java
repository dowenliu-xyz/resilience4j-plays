...
public class Case196Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case196JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case196JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case196KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case196KotlinSuperKotlinDemo")
