...
public class Case119Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case119JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case119JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case119KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case119KotlinSuperKotlinDemo")
