...
public class Case070Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case070JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case070JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case070KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case070KotlinSuperKotlinDemo")
