...
public class Case054Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case054JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case054JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case054KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case054KotlinSuperKotlinDemo")
