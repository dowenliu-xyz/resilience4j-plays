...
public class Case148Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case148JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case148JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case148KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case148KotlinSuperKotlinDemo")
