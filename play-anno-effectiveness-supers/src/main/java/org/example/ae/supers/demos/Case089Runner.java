...
public class Case089Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case089JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case089JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case089KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case089KotlinSuperKotlinDemo")
