...
public class Case001Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case001JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case001JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case001KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case001KotlinSuperKotlinDemo")
