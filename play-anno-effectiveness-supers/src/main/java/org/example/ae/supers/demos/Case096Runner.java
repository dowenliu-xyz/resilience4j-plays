...
public class Case096Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case096JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case096JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case096KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case096KotlinSuperKotlinDemo")
