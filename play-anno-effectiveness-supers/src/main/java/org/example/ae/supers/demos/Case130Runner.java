...
public class Case130Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case130JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case130JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case130KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case130KotlinSuperKotlinDemo")
