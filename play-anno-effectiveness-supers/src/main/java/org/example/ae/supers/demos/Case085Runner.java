...
public class Case085Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case085JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case085JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case085KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case085KotlinSuperKotlinDemo")
