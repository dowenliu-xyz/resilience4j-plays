...
public class Case104Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case104JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case104JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case104KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case104KotlinSuperKotlinDemo")
