...
public class Case129Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case129JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case129JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case129KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case129KotlinSuperKotlinDemo")
