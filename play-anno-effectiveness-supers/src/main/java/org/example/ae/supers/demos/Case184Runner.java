...
public class Case184Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case184JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case184JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case184KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case184KotlinSuperKotlinDemo")
