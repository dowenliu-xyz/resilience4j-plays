...
public class Case066Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case066JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case066JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case066KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case066KotlinSuperKotlinDemo")
