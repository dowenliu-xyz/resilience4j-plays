...
public class Case110Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case110JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case110JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case110KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case110KotlinSuperKotlinDemo")
