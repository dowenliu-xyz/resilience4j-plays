...
public class Case155Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case155JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case155JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case155KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case155KotlinSuperKotlinDemo")
