...
public class Case088Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case088JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case088JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case088KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case088KotlinSuperKotlinDemo")
