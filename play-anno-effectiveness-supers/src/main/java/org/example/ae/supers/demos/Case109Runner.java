...
public class Case109Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case109JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case109JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case109KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case109KotlinSuperKotlinDemo")
