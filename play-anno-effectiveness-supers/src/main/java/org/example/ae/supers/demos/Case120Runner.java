...
public class Case120Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case120JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case120JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case120KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case120KotlinSuperKotlinDemo")
