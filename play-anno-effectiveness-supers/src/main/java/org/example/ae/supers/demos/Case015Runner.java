...
public class Case015Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case015JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case015JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case015KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case015KotlinSuperKotlinDemo")
