...
public class Case003Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case003JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case003JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case003KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case003KotlinSuperKotlinDemo")
