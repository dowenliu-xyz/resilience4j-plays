...
public class Case042Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case042JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case042JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case042KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case042KotlinSuperKotlinDemo")
