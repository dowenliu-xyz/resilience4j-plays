...
public class Case144Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case144JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case144JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case144KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case144KotlinSuperKotlinDemo")
