...
public class Case170Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case170JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case170JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case170KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case170KotlinSuperKotlinDemo")
