...
public class Case139Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case139JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case139JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case139KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case139KotlinSuperKotlinDemo")
