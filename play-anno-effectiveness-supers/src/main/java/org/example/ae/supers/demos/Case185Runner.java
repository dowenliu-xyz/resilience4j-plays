...
public class Case185Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case185JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case185JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case185KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case185KotlinSuperKotlinDemo")
