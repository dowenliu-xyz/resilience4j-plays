...
public class Case141Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case141JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case141JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case141KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case141KotlinSuperKotlinDemo")
