...
public class Case013Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case013JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case013JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case013KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case013KotlinSuperKotlinDemo")
