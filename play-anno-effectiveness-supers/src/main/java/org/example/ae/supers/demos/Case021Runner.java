...
public class Case021Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case021JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case021JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case021KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case021KotlinSuperKotlinDemo")
