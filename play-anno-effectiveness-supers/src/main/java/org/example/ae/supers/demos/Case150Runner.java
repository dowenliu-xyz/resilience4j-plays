...
public class Case150Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case150JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case150JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case150KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case150KotlinSuperKotlinDemo")
