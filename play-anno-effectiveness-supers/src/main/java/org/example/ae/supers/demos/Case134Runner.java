...
public class Case134Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case134JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case134JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case134KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case134KotlinSuperKotlinDemo")
