...
public class Case125Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case125JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case125JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case125KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case125KotlinSuperKotlinDemo")
