...
public class Case091Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case091JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case091JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case091KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case091KotlinSuperKotlinDemo")
