...
public class Case111Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case111JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case111JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case111KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case111KotlinSuperKotlinDemo")
