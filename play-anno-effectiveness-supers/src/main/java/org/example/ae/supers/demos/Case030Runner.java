...
public class Case030Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case030JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case030JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case030KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case030KotlinSuperKotlinDemo")
