...
public class Case081Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case081JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case081JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case081KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case081KotlinSuperKotlinDemo")
