...
public class Case194Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case194JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case194JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case194KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case194KotlinSuperKotlinDemo")
