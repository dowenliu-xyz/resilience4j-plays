...
public class Case180Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case180JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case180JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case180KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case180KotlinSuperKotlinDemo")
