...
public class Case181Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case181JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case181JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case181KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case181KotlinSuperKotlinDemo")
