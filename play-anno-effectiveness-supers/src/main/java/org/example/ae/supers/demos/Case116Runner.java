...
public class Case116Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case116JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case116JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case116KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case116KotlinSuperKotlinDemo")
