...
public class Case024Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case024JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case024JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case024KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case024KotlinSuperKotlinDemo")
