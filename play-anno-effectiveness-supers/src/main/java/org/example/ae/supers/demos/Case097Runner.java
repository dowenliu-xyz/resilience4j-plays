...
public class Case097Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case097JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case097JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case097KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case097KotlinSuperKotlinDemo")
