...
public class Case106Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case106JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case106JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case106KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case106KotlinSuperKotlinDemo")
