...
public class Case152Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case152JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case152JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case152KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case152KotlinSuperKotlinDemo")
