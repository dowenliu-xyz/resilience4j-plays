...
public class Case072Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case072JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case072JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case072KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case072KotlinSuperKotlinDemo")
