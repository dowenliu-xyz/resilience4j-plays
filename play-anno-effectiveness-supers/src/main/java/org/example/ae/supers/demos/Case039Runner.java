...
public class Case039Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case039JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case039JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case039KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case039KotlinSuperKotlinDemo")
