...
public class Case168Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case168JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case168JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case168KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case168KotlinSuperKotlinDemo")
