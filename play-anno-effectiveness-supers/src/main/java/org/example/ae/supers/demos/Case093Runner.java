...
public class Case093Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case093JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case093JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case093KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case093KotlinSuperKotlinDemo")
