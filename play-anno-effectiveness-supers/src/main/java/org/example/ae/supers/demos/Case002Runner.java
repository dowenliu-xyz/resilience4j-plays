...
public class Case002Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case002JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case002JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case002KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case002KotlinSuperKotlinDemo")
