...
public class Case020Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case020JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case020JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case020KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case020KotlinSuperKotlinDemo")
