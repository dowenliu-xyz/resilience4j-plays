...
public class Case061Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case061JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case061JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case061KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case061KotlinSuperKotlinDemo")
