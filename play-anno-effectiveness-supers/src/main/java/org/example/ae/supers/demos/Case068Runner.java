...
public class Case068Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case068JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case068JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case068KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case068KotlinSuperKotlinDemo")
