...
public class Case073Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case073JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case073JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case073KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case073KotlinSuperKotlinDemo")
