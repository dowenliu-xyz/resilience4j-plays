...
public class Case095Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case095JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case095JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case095KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case095KotlinSuperKotlinDemo")
