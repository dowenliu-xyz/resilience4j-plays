...
public class Case018Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case018JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case018JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case018KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case018KotlinSuperKotlinDemo")
