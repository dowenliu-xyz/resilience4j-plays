...
public class Case126Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case126JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case126JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case126KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case126KotlinSuperKotlinDemo")
