...
public class Case112Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case112JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case112JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case112KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case112KotlinSuperKotlinDemo")
