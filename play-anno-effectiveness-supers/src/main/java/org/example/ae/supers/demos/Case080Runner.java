...
public class Case080Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case080JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case080JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case080KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case080KotlinSuperKotlinDemo")
