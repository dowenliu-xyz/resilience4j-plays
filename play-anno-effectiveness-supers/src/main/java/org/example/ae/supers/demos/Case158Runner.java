...
public class Case158Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case158JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case158JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case158KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case158KotlinSuperKotlinDemo")
