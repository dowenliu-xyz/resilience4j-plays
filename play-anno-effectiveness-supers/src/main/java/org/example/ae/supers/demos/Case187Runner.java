...
public class Case187Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case187JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case187JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case187KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case187KotlinSuperKotlinDemo")
