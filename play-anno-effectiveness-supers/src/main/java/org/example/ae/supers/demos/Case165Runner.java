...
public class Case165Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case165JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case165JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case165KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case165KotlinSuperKotlinDemo")
