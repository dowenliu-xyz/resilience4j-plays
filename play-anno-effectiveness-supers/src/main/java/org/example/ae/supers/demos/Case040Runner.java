...
public class Case040Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case040JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case040JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case040KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case040KotlinSuperKotlinDemo")
