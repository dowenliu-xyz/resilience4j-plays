...
public class Case016Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case016JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case016JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case016KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case016KotlinSuperKotlinDemo")
