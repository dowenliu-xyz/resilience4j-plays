...
public class Case090Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case090JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case090JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case090KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case090KotlinSuperKotlinDemo")
