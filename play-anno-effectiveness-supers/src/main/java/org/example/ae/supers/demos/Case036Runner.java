...
public class Case036Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case036JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case036JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case036KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case036KotlinSuperKotlinDemo")
