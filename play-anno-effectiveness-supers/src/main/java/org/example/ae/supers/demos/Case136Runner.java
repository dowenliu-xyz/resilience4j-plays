...
public class Case136Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case136JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case136JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case136KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case136KotlinSuperKotlinDemo")
