...
public class Case049Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case049JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case049JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case049KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case049KotlinSuperKotlinDemo")
