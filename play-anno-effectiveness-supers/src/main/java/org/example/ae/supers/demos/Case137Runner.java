...
public class Case137Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case137JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case137JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case137KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case137KotlinSuperKotlinDemo")
