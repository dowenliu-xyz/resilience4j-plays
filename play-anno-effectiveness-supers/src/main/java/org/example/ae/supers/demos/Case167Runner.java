...
public class Case167Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case167JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case167JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case167KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case167KotlinSuperKotlinDemo")
