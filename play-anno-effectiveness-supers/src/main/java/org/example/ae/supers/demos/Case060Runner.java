...
public class Case060Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case060JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case060JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case060KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case060KotlinSuperKotlinDemo")
