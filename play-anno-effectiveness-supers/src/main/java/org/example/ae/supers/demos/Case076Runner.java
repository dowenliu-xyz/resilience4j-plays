...
public class Case076Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case076JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case076JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case076KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case076KotlinSuperKotlinDemo")
