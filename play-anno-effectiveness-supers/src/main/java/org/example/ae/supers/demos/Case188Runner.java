...
public class Case188Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case188JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case188JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case188KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case188KotlinSuperKotlinDemo")
