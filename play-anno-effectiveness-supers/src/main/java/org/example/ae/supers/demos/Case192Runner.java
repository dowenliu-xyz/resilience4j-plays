...
public class Case192Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case192JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case192JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case192KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case192KotlinSuperKotlinDemo")
