...
public class Case050Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case050JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case050JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case050KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case050KotlinSuperKotlinDemo")
