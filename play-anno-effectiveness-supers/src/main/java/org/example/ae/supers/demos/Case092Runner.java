...
public class Case092Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case092JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case092JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case092KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case092KotlinSuperKotlinDemo")
