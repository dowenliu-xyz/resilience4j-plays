...
public class Case083Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case083JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case083JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case083KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case083KotlinSuperKotlinDemo")
