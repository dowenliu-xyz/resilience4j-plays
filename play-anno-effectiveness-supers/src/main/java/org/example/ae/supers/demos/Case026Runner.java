...
public class Case026Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case026JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case026JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case026KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case026KotlinSuperKotlinDemo")
