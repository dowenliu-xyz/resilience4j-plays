...
public class Case010Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case010JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case010JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case010KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case010KotlinSuperKotlinDemo")
