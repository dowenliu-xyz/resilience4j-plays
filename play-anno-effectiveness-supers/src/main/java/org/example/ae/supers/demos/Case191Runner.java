...
public class Case191Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case191JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case191JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case191KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case191KotlinSuperKotlinDemo")
