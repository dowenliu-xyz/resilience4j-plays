...
public class Case008Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case008JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case008JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case008KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case008KotlinSuperKotlinDemo")
