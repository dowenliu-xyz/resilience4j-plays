...
public class Case128Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case128JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case128JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case128KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case128KotlinSuperKotlinDemo")
