...
public class Case048Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case048JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case048JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case048KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case048KotlinSuperKotlinDemo")
