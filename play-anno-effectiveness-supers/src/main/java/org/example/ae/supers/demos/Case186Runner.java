...
public class Case186Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case186JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case186JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case186KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case186KotlinSuperKotlinDemo")
