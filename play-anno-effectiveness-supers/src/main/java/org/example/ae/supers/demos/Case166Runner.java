...
public class Case166Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case166JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case166JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case166KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case166KotlinSuperKotlinDemo")
