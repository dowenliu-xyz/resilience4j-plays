...
public class Case023Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case023JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case023JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case023KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case023KotlinSuperKotlinDemo")
