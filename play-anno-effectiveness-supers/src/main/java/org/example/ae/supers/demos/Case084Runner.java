...
public class Case084Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case084JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case084JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case084KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case084KotlinSuperKotlinDemo")
