...
public class Case189Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case189JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case189JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case189KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case189KotlinSuperKotlinDemo")
