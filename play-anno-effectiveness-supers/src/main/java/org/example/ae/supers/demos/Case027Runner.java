...
public class Case027Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case027JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case027JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case027KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case027KotlinSuperKotlinDemo")
