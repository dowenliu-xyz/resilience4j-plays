...
public class Case019Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case019JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case019JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case019KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case019KotlinSuperKotlinDemo")
