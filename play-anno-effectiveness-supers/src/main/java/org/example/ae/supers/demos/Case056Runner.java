...
public class Case056Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case056JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case056JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case056KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case056KotlinSuperKotlinDemo")
