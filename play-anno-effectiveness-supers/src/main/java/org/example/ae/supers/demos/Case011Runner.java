...
public class Case011Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case011JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case011JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case011KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case011KotlinSuperKotlinDemo")
