...
public class Case193Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case193JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case193JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case193KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case193KotlinSuperKotlinDemo")
