...
public class Case037Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case037JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case037JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case037KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case037KotlinSuperKotlinDemo")
