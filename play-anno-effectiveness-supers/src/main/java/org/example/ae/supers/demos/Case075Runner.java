...
public class Case075Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case075JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case075JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case075KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case075KotlinSuperKotlinDemo")
