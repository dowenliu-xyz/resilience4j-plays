...
public class Case169Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case169JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case169JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case169KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case169KotlinSuperKotlinDemo")
