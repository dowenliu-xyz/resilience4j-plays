...
public class Case031Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case031JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case031JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case031KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case031KotlinSuperKotlinDemo")
