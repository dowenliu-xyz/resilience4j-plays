...
public class Case172Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case172JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case172JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case172KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case172KotlinSuperKotlinDemo")
