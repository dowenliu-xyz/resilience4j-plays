...
public class Case079Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case079JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case079JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case079KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case079KotlinSuperKotlinDemo")
