...
public class Case032Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case032JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case032JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case032KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case032KotlinSuperKotlinDemo")
