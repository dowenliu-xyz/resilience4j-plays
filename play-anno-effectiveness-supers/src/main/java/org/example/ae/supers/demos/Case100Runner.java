...
public class Case100Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case100JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case100JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case100KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case100KotlinSuperKotlinDemo")
