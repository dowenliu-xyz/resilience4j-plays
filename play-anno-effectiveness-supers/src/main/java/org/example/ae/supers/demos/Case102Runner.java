...
public class Case102Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case102JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case102JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case102KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case102KotlinSuperKotlinDemo")
