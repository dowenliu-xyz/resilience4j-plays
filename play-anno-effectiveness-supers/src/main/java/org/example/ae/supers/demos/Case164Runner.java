...
public class Case164Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case164JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case164JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case164KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case164KotlinSuperKotlinDemo")
