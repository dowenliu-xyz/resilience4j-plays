...
public class Case029Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case029JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case029JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case029KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case029KotlinSuperKotlinDemo")
