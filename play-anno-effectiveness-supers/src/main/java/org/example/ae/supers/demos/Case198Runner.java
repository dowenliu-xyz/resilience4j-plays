...
public class Case198Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case198JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case198JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case198KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case198KotlinSuperKotlinDemo")
