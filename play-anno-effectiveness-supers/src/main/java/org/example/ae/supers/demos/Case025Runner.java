...
public class Case025Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case025JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case025JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case025KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case025KotlinSuperKotlinDemo")
