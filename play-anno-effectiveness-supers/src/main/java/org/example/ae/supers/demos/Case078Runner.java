...
public class Case078Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case078JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case078JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case078KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case078KotlinSuperKotlinDemo")
