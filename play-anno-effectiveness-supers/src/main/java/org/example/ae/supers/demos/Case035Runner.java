...
public class Case035Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case035JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case035JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case035KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case035KotlinSuperKotlinDemo")
