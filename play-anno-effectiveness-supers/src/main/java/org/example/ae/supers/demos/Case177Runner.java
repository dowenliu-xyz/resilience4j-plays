...
public class Case177Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case177JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case177JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case177KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case177KotlinSuperKotlinDemo")
