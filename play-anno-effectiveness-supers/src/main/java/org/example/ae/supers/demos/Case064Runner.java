...
public class Case064Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case064JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case064JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case064KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case064KotlinSuperKotlinDemo")
