...
public class Case069Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case069JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case069JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case069KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case069KotlinSuperKotlinDemo")
