...
public class Case033Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case033JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case033JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case033KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case033KotlinSuperKotlinDemo")
