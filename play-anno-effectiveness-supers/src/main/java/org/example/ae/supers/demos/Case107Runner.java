...
public class Case107Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case107JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case107JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case107KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case107KotlinSuperKotlinDemo")
