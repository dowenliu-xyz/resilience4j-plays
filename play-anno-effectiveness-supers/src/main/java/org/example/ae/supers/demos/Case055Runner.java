...
public class Case055Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case055JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case055JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case055KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case055KotlinSuperKotlinDemo")
