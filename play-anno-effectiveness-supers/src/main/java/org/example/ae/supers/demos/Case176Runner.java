...
public class Case176Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case176JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case176JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case176KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case176KotlinSuperKotlinDemo")
