...
public class Case143Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case143JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case143JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case143KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case143KotlinSuperKotlinDemo")
