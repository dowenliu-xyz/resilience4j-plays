...
public class Case195Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case195JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case195JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case195KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case195KotlinSuperKotlinDemo")
