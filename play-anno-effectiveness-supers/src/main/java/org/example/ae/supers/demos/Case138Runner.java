...
public class Case138Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case138JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case138JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case138KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case138KotlinSuperKotlinDemo")
