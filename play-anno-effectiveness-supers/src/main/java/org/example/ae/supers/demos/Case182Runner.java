...
public class Case182Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case182JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case182JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case182KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case182KotlinSuperKotlinDemo")
