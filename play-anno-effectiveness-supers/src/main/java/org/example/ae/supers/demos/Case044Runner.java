...
public class Case044Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case044JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case044JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case044KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case044KotlinSuperKotlinDemo")
