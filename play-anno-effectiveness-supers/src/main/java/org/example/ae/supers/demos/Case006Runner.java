...
public class Case006Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case006JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case006JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case006KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case006KotlinSuperKotlinDemo")
