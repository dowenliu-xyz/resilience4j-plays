...
public class Case045Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case045JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case045JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case045KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case045KotlinSuperKotlinDemo")
