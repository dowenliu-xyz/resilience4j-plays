...
public class Case121Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case121JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case121JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case121KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case121KotlinSuperKotlinDemo")
