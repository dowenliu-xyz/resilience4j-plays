...
public class Case151Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case151JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case151JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case151KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case151KotlinSuperKotlinDemo")
