...
public class Case053Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case053JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case053JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case053KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case053KotlinSuperKotlinDemo")
