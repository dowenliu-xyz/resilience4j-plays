...
public class Case123Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case123JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case123JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case123KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case123KotlinSuperKotlinDemo")
