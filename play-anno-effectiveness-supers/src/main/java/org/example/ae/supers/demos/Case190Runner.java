...
public class Case190Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case190JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case190JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case190KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case190KotlinSuperKotlinDemo")
