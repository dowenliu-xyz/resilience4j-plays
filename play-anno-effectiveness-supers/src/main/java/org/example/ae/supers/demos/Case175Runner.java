...
public class Case175Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case175JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case175JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case175KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case175KotlinSuperKotlinDemo")
