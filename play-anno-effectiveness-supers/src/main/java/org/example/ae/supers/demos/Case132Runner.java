...
public class Case132Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case132JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case132JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case132KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case132KotlinSuperKotlinDemo")
