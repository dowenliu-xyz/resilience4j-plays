...
public class Case041Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case041JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case041JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case041KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case041KotlinSuperKotlinDemo")
