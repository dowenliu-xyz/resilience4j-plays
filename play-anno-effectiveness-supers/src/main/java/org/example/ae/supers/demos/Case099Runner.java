...
public class Case099Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case099JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case099JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case099KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case099KotlinSuperKotlinDemo")
