...
public class Case098Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case098JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case098JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case098KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case098KotlinSuperKotlinDemo")
