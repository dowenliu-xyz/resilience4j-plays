...
public class Case086Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case086JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case086JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case086KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case086KotlinSuperKotlinDemo")
