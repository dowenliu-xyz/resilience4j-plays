...
public class Case004Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case004JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case004JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case004KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case004KotlinSuperKotlinDemo")
