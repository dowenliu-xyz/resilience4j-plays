...
public class Case113Runner implements CommandLineRunner, Ordered {
    @Resource(name = "case113JavaSuperJavaDemo")
    private DemoCase javaSuperJavaDemo;
    @Resource(name = "case113JavaSuperKotlinDemo")
    private DemoCase javaSuperKotlinDemo;
    @Resource(name = "case113KotlinSuperJavaDemo")
    private DemoCase kotlinSuperJavaDemo;
    @Resource(name = "case113KotlinSuperKotlinDemo")
