package org.example.jp;

import lombok.RequiredArgsConstructor;
import org.example.jp.demos.annobase.interfaces.*;
import org.example.jp.demos.annobase.parents.AnnoBaseJavaParentJavaDemo;
import org.example.jp.demos.annobase.parents.AnnoBaseJavaParentKotlinDemo;
import org.example.jp.demos.annobase.parents.AnnoBaseKotlinParentJavaDemo;
import org.example.jp.demos.annobase.parents.AnnoBaseKotlinParentKotlinDemo;
import org.example.jp.demos.annobase.self.AnnoBaseSelfJavaDemo;
import org.example.jp.demos.annobase.self.AnnoBaseSelfKotlinDemo;
import org.example.jp.demos.javabase.interfaces.*;
import org.example.jp.demos.javabase.parents.JavaBaseJavaParentJavaDemo;
import org.example.jp.demos.javabase.parents.JavaBaseJavaParentKotlinDemo;
import org.example.jp.demos.javabase.parents.JavaBaseKotlinParentJavaDemo;
import org.example.jp.demos.javabase.parents.JavaBaseKotlinParentKotlinDemo;
import org.example.jp.demos.javabase.self.JavaBaseSelfJavaDemo;
import org.example.jp.demos.javabase.self.JavaBaseSelfKotlinDemo;
